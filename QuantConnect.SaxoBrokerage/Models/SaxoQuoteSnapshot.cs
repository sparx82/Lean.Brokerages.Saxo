...
/// <summary>
/// Represents a snapshot of quotes retrieved from Saxo, along with any associated errors.
/// </summary>
public readonly struct SaxoQuoteSnapshot
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SaxoQuoteSnapshot"/> struct.
    /// </summary>
    /// <param name="quotes">The collection of quotes.</param>
    /// <param name="errors">The collection of errors, if any.</param>
    [JsonConstructor]
    public SaxoQuoteSnapshot(List<Quote> quotes, List<QuoteError> errors)
    {
        Quotes = quotes;
        Errors = errors;
    }
