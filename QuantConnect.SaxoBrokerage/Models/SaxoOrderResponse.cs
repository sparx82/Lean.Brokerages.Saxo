...
public readonly struct SaxoOrderResponse : ISaxoError
{
    /// <summary>
    /// Gets the collection of orders associated with the positions.
    /// </summary>
    public List<SaxoOrder> Orders { get; }
    ...
    [JsonConstructor]
    public SaxoOrderResponse(List<SaxoOrder> orders, List<SaxoError> errors, string nextToken)
    {
        Orders = orders;
        Errors = errors;
        NextToken = nextToken;
...
public readonly struct SaxoOrder
{
    /// <summary>
    /// Saxo Account ID.
    /// </summary>
    ...
    public SaxoDuration Duration { get; }
    ...
    /// </summary>
    [JsonConverter(typeof(StringEnumConverter))]
    public SaxoOrderStatusType Status { get; }
    ...
    [JsonConstructor]
    public SaxoOrder(string accountID, string advancedOptions, DateTime closedDateTime, decimal commissionFee, List<ConditionalOrder> conditionalOrders,
        string conversionRate, string currency, SaxoDuration duration, string filledPrice, DateTime goodTillDate, string groupName, List<Leg> legs,
        ...
        DateTime openedDateTime, SaxoOrderType orderType, string priceUsedForBuyingPower, string rejectReason, string routing, string showOnlyQuantity,
        string spread, SaxoOrderStatusType status, string statusDescription, decimal stopPrice, TrailingStop trailingStop, string unbundledRouteFee)
    {
        AccountID = accountID;
...
public readonly struct Leg
{
    ...
    /// </summary>
    [JsonConverter(typeof(StringEnumConverter))]
    public SaxoTradeActionType BuyOrSell { get; }
    ...
    /// </summary>
    [JsonConverter(typeof(StringEnumConverter))]
    public SaxoOptionType OptionType { get; }
    ...
    [JsonConstructor]
    public Leg(string openOrClose, decimal quantityOrdered, decimal execQuantity, decimal quantityRemaining, SaxoTradeActionType buyOrSell, string symbol, string underlying,
        SaxoAssetType assetType, decimal executionPrice, DateTime expirationDate, SaxoOptionType optionType, decimal strikePrice)
    {
