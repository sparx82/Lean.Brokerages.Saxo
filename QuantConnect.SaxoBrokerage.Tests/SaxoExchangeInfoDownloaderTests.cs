...
{
    [TestFixture, Ignore("This test requires a configured SaxoExchangeInfoDownloader")]
    public class SaxoExchangeInfoDownloaderTests
    {
        [Test]
        public void GetsExchangeInfo()
        {
            var eid = Composer.Instance.GetExportedValueByTypeName<IExchangeInfoDownloader>("SaxoExchangeInfoDownloader");
